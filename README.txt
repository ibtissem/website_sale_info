...
1. /models/website_sale_info.py: I added one2many field in the website object to be able to get information 
	from website_sale_info object from the website.
...
3. /static/src/js/sale_info.js: I added onclick functions in witch i defined what happend after clicking the 
	button in the delivery and the payment which is to dynamically display a template based on the specific 
	delivery or payment order.
